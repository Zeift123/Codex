document.addEventListener('DOMContentLoaded', () => {
  ...
  const bgSprites = [
    'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><ellipse cx="50" cy="60" rx="30" ry="25" fill="%23ffcb05" stroke="%231a1a1a" stroke-width="4"/><circle cx="35" cy="55" r="5" fill="%231a1a1a"/><circle cx="65" cy="55" r="5" fill="%231a1a1a"/><circle cx="32" cy="65" r="4" fill="%23e63838"/><circle cx="68" cy="65" r="4" fill="%23e63838"/><path d="M40 70 q10 10 20 0" stroke="%231a1a1a" stroke-width="4" fill="none"/><path d="M30 40 l-10 -20 20 10" fill="%23ffcb05" stroke="%231a1a1a" stroke-width="4"/><path d="M70 40 l10 -20 -20 10" fill="%23ffcb05" stroke="%231a1a1a" stroke-width="4"/><path d="M75 60 l20 5 -20 5" fill="%23ffcb05" stroke="%231a1a1a" stroke-width="4"/></svg>'
  ];
  for (let i = 0; i < 9; i++) {
